...
// which pointInRegionGeom can't hit-test, so users in either hemisphere never
// got these auto-dropped from the Regionals collector list. We synthesize
// east/west polygons keyed to the current Niantic rotation. Update both arrays
// when Niantic announces a swap (Leek Duck / GO Hub post the day-of).
// Last verified May 2026.
const POGO_REGIONS_ROTATING = [
  {
    folder: "Type 3/4 [Rotating Pairs] (current rotation, manually maintained)",
    name: "Eastern Hemisphere paired/hemispheric",
    english: ["Zangoose", "Sawk", "Solrock", "Heatmor"],
    german:  ["Sengo",    "Karadonis", "Sonnfel", "Furnifraß"],
    geometry: { type: "Polygon", coordinates: [[[0, -85], [180, -85], [180, 85], [0, 85], [0, -85]]] },
  },
  {
    folder: "Type 3/4 [Rotating Pairs] (current rotation, manually maintained)",
    name: "Western Hemisphere paired/hemispheric",
    english: ["Seviper", "Throh",    "Lunatone",  "Durant"],
    german:  ["Vipitis", "Jiutesto", "Lunastein", "Fermicula"],
    geometry: { type: "Polygon", coordinates: [[[-180, -85], [0, -85], [0, 85], [-180, 85], [-180, -85]]] },
  },
];
