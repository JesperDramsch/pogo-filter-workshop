...
export function buildFilters(
	...
	for (const dex of ownedDexList(luckies))
		push(friendLuckyClauses, `!+${speciesForOutput(dex, outputLocale)}`, tFn('app.clause_why.friend_have_lucky', { params: { dex } }));
	...
	for (const dex of ownedDexList(hundos))
		push(friendHundoClauses, `!+${speciesForOutput(dex, outputLocale)}`, tFn('app.clause_why.friend_have_hundo', { params: { dex } }));
